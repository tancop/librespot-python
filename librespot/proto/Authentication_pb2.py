...
_LOGINCREDENTIALS = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="auth_type",
            full_name="spotify.LoginCredentials.auth_type",
            index=1,
            number=20,
            type=14,
            cpp_type=8,
...
_LOGINCREDENTIALS.fields_by_name["auth_type"].enum_type = _AUTHENTICATIONTYPE
...
DESCRIPTOR.message_types_by_name["FingerprintHmacRipemdResponse"] = (
